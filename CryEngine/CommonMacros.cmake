...
function(CryUnitTestSuite target)
...
macro(use_scaleform)
	if (OPTION_SCALEFORMHELPER)
		...
		if (EXISTS ${SDK_DIR}/Scaleform)
			...
			message(" ${LIBPATH_FLAG}/${SCALEFORM_LIB_FOLDER}/${SCALEFORM_RELEASE_CONFIG}/")
